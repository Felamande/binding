...
func (v FileAction) Post() error {
	errors = v.MultipartForm(obj)
	/*if errors.Len() > 0 {
		return errors
	}*/
	return nil
...
func performFileTest(t *testing.T, testCase fileTestCase) {
	...
	obj = &BlogPost{}
	m.Post(testRoute, new(FileAction))
	...
	fileTestHandler(*(obj.(*BlogPost)), errors)
}
